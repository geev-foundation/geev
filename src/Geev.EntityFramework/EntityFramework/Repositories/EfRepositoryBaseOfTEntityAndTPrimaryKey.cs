...
namespace Geev.EntityFramework.Repositories
{
    ...
    public class EfRepositoryBase<TDbContext, TEntity, TPrimaryKey> : GeevRepositoryBase<TEntity, TPrimaryKey>, IRepositoryWithDbContext, ISupportsExplicitLoading<TEntity, TPrimaryKey>
        ...
        where TDbContext : DbContext
    {
            ...
            CancellationToken cancellationToken) where TProperty : class
        {
            ...
            if (expression == null)
            {
                throw new GeevException($"Given {nameof(collectionExpression)} is not a {typeof(MemberExpression).FullName}");
            }
