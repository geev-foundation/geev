...
namespace Geev.AspNetCore.Mvc.Antiforgery
{
    public class GeevAutoValidateAntiforgeryTokenAuthorizationFilter : AutoValidateAntiforgeryTokenAuthorizationFilter, ITransientDependency
    {
        ...
        private readonly IGeevAntiForgeryConfiguration _antiForgeryConfiguration;

        public GeevAutoValidateAntiforgeryTokenAuthorizationFilter(
            IAntiforgery antiforgery, 
            ILoggerFactory loggerFactory,
            IOptions<AntiforgeryOptions> antiforgeryOptions, 
            IGeevAntiForgeryConfiguration antiForgeryConfiguration,
