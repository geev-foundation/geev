...
using Geev.AspNetCore.Mvc.Proxying.Utils;
...
namespace Geev.AspNetCore.Mvc.Proxying
{
    public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ISingletonDependency
    {
        ...
        private readonly GeevAspNetCoreConfiguration _configuration;
        ...
        public AspNetCoreApiDescriptionModelProvider(
            ...
            GeevAspNetCoreConfiguration configuration,
        ...
        private string GetModuleName(ApiDescription apiDescription)
        {
            ...
            {
                return GeevControllerAssemblySetting.DefaultServiceModuleName;
            }
