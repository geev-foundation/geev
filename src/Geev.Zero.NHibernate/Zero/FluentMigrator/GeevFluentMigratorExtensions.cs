...
namespace Geev.Zero.FluentMigrator
{
    ...
    /// </summary>
    public static class GeevZeroFluentMigratorExtensions
    {
        #region Create table
        ...
        {
            return table
                .WithColumn("CreatorUserId").AsInt64().Nullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        {
            return table
                .WithColumn("LastModifierUserId").AsInt64().Nullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        {
            return table
                .WithColumn("DeleterUserId").AsInt64().Nullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        /// <summary>
        /// Adds TenantId column to a table as not nullable. See <see cref="GeevTenant{TUser}"/>.
        /// </summary>
        ...
        {
            return table
                .WithColumn("TenantId").AsInt32().NotNullable().ForeignKey("GeevTenants", "Id");
        }

        /// <summary>
        /// Adds TenantId column to a table as nullable. See <see cref="GeevTenant{TUser}"/>.
        /// </summary>
        ...
        {
            return table
                .WithColumn("TenantId").AsInt32().Nullable().ForeignKey("GeevTenants", "Id");
        }
        ...
        {
            return table
                .WithColumn(columnName).AsInt64().NotNullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        {
            return table
                .WithColumn(columnName).AsInt64().Nullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        {
            return table
                .AddColumn("CreatorUserId").AsInt64().Nullable().ForeignKey("GeevUsers", "Id");
        }
        ...
        {
            return table
                .AddColumn("TenantId").AsInt32().NotNullable().ForeignKey("GeevTenants", "Id");
        }
        ...
        {
            return table
                .AddColumn("TenantId").AsInt32().Nullable().ForeignKey("GeevTenants", "Id");
        }
