    ...
    public class MustHaveTenantDapperQueryFilter : IDapperQueryFilter
    {
        ...
        private int TenantId
        {
            get
            {
                ...
                if (filter.FilterParameters.ContainsKey(GeevDataFilters.Parameters.TenantId))
                {
                    return (int)filter.FilterParameters[GeevDataFilters.Parameters.TenantId];
                }
        ...
        public string FilterName { get; } = GeevDataFilters.MustHaveTenant;
