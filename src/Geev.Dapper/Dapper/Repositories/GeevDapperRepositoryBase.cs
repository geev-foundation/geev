...
namespace Geev.Dapper.Repositories
{
    ...
    public abstract class GeevDapperRepositoryBase<TEntity, TPrimaryKey> : IDapperRepository<TEntity, TPrimaryKey> where TEntity : class, IEntity<TPrimaryKey>
    {
        public static MultiTenancySides? MultiTenancySide { get; private set; }

        static GeevDapperRepositoryBase()
        {
