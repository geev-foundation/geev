...
using Geev.Dapper.Extensions;
using Geev.Dapper.Filters.Action;
...
{
    public class DapperRepositoryBase<TEntity, TPrimaryKey> : GeevDapperRepositoryBase<TEntity, TPrimaryKey>
