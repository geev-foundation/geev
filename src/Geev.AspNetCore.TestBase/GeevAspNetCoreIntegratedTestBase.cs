...
{
    public abstract class GeevAspNetCoreIntegratedTestBase<TStartup> 
        where TStartup : class
    {
        ...
        protected TestGeevSession GeevSession { get; }

        protected GeevAspNetCoreIntegratedTestBase()
        {
            ...
            GeevSession = ServiceProvider.GetRequiredService<TestGeevSession>();
        }
