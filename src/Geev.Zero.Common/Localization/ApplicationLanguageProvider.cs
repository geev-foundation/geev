...
namespace Geev.Localization
{
    ...
    public class ApplicationLanguageProvider : ILanguageProvider
    {
        ...
        {
            var languageInfos = AsyncHelper.RunSync(() => _applicationLanguageManager.GetLanguagesAsync(GeevSession.TenantId))
        ...
        private void SetDefaultLanguage(List<LanguageInfo> languageInfos)
        {
            ...
            var defaultLanguage = AsyncHelper.RunSync(() => _applicationLanguageManager.GetDefaultLanguageOrNullAsync(GeevSession.TenantId));
