...
namespace Geev.Auditing
{
    ...
    public class AuditLog : Entity<long>, IMayHaveTenant
    {
        ...
        {
            var exceptionMessage = GetGeevClearException(auditInfo.Exception);
            return new AuditLog
                   {
        ...
        /// <returns></returns>
        public static string GetGeevClearException(Exception exception)
        {
            var clearMessage = "";
            switch (exception)
            {
                ...
                case GeevValidationException geevValidationException:
                    clearMessage = "There are " + geevValidationException.ValidationErrors.Count + " validation errors:";
                    foreach (var validationResult in geevValidationException.ValidationErrors) 
                    {
                        var memberNames = "";
