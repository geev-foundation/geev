...
namespace Geev.Runtime.Caching.Redis
{
    ...
    public class DefaultRedisCacheSerializer : IRedisCacheSerializer, ITransientDependency
    {
        ...
        public virtual object Deserialize(RedisValue objbyte)
        {
            ...
            serializerSettings.Converters.Insert(0, new GeevDateTimeConverter());

            GeevCacheData cacheData = GeevCacheData.Deserialize(objbyte);
        ...
        {
            return JsonConvert.SerializeObject(GeevCacheData.Serialize(value));
        }
    }
}