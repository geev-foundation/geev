...
namespace Geev.Runtime.Caching.Redis
{
    ...
    /// </summary>
    public class GeevRedisCache : CacheBase
    {
        ...
        /// Constructor.
        /// </summary>
        public GeevRedisCache(
            string name,
            IGeevRedisCacheDatabaseProvider redisCacheDatabaseProvider,
        ...
        public override void Set(string key, object value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null)
        {
            if (value == null)
            {
                throw new GeevException("Can not insert null values to the cache!");
            }
        ...
        protected virtual Type GetSerializableType(object value)
        {
            ...
            //TODO: Normally, entities should not be stored in the cache, but currently Geev.Zero packages does it. It will be fixed in the future.
