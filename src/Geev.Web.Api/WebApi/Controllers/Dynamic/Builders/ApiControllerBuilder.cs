...
using Geev.WebApi.Controllers.Dynamic.Interceptors;
...
namespace Geev.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal class ApiControllerBuilder<T> : IApiControllerBuilder<T>
    {
        ...
        public IApiControllerActionBuilder<T> ForMethod(string methodName)
        {
            ...
            {
                throw new GeevException("There is no method with name " + methodName + " in type " + typeof(T).Name);
            }
        ...
        public void Build()
        {
            var controllerInfo = new DynamicApiControllerInfo(
                ...
                typeof(GeevDynamicApiControllerInterceptor<T>),
                Filters,
