...
{
    /// <summary>
    /// This class is used to extend default controller selector to add dynamic api controller creation feature of Geev.
    ...
    /// </summary>
    public class GeevHttpControllerSelector : DefaultHttpControllerSelector
    {
        private readonly HttpConfiguration _configuration;
        private readonly DynamicApiControllerManager _dynamicApiControllerManager;

        /// <summary>
        /// Creates a new <see cref="GeevHttpControllerSelector"/> object.
        /// </summary>
        /// <param name="configuration">Http configuration</param>
        /// <param name="dynamicApiControllerManager"></param>
        public GeevHttpControllerSelector(HttpConfiguration configuration, DynamicApiControllerManager dynamicApiControllerManager)
            : base(configuration)
        {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            controllerDescriptor.Properties["__GeevDynamicApiControllerInfo"] = controllerInfo;
            controllerDescriptor.Properties["__GeevDynamicApiHasActionName"] = hasActionName;
