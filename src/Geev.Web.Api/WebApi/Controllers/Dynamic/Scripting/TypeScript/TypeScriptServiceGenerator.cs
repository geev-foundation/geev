    ...
    public class TypeScriptServiceGenerator : ITransientDependency
    {
        ...
        public string GetScript()
        {
            ...
            if (servicePrefix.IsNullOrEmpty())
                script.AppendLine("module geev.services");//Create a new Module
            else
                script.AppendLine("module geev.services." + servicePrefix);//Create a new Module
            script.AppendLine("{");
            ...
            script.AppendLine("}");
            #region Create Script for Geev common objects

            script.AppendLine("declare module geev {");
