...
namespace Geev.WebApi.Controllers.Dynamic.Scripting.Angular
{
    internal class AngularProxyGenerator : IScriptProxyGenerator
    {
        ...
        public string Generate()
        {
            ...
            script.AppendLine("(function (geev, angular) {");
            script.AppendLine("");
            script.AppendLine("    if (!angular) {");
            script.AppendLine("        return;");
            script.AppendLine("    }");
            script.AppendLine("    ");
            script.AppendLine("    var geevModule = angular.module('geev');");
            script.AppendLine("    ");
            script.AppendLine("    geevModule.factory('geev.services." + _controllerInfo.ServiceName.Replace("/", ".") + "', [");
            ...
            script.AppendLine();
            script.AppendLine("})((geev || (geev = {})), (angular || undefined));");
