...
namespace Geev.WebApi.Controllers.Dynamic.Interceptors
{
    /// <summary>
    ...
    public class GeevDynamicApiControllerInterceptor<T> : IInterceptor
    {
        /// <summary>
