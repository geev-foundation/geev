...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use Geev system.
    /// </summary>
    public abstract class GeevApiController : ApiController
    {
        /// <summary>
