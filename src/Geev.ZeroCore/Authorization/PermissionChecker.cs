...
namespace Geev.Authorization
{
        ...
        where TUser : GeevUser<TUser>
    {
        ...
        /// Constructor.
        /// </summary>
        public PermissionChecker(GeevUserManager<TRole, TUser> userManager)
        {
        ...
        {
            return GeevSession.UserId.HasValue && await IsGrantedAsync(GeevSession.UserId.Value, permissionName);
        }
