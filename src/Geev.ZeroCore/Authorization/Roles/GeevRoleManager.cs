...
{
    public class GeevRoleManager<TRole, TUser> : RoleManager<TRole>, IDomainService
        ...
        where TUser : GeevUser<TUser>
    {
        ...
        protected GeevRoleStore<TRole, TUser> GeevStore { get; }
        ...
        public GeevRoleManager(
            GeevRoleStore<TRole, TUser> store,
            IEnumerable<IRoleValidator<TRole>> roleValidators,
            ILookupNormalizer keyNormalizer,
            IdentityErrorDescriber errors,
            ILogger<GeevRoleManager<TRole, TUser>> logger,
