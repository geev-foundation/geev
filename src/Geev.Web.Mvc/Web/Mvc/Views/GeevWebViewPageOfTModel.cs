...
namespace Geev.Web.Mvc.Views
{
    /// <summary>
    /// Base class for all views in Geev system.
    /// </summary>
    /// <typeparam name="TModel">Type of the View Model</typeparam>
    public abstract class GeevWebViewPage<TModel> : WebViewPage<TModel>
    {
        /// <summary>
        ...
        {
            SingletonDependency<IGeevAntiForgeryManager>.Instance.SetCookie(Context);
        }
    }
}
