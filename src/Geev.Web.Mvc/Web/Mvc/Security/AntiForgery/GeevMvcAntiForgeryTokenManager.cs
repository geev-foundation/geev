...
{
    public class GeevMvcAntiForgeryManager : GeevAntiForgeryManager
    {
        private static readonly Lazy<object> AntiForgeryWorkerObject = new Lazy<object>(() =>
        {
            ...
            {
                throw new GeevException("Can not get _worker field of System.Web.Helpers.AntiForgery class. It's internal implementation might be changed. Please create an issue on GitHub repository to solve this.");
            }
        ...
        public GeevMvcAntiForgeryManager(IGeevAntiForgeryConfiguration configuration)
            : base(configuration)
        {
