...
using Geev.Web.Mvc.Models;
using Castle.Core.Logging;

namespace Geev.Web.Mvc.Controllers
{
    /// <summary>
    /// Base class for all MVC Controllers in Geev system.
    /// </summary>
    public abstract class GeevController : Controller
    {
        /// <summary>
        ...
        public IUnitOfWorkManager UnitOfWorkManager
        {
            get
            {
                ...
                {
                    throw new GeevException("Must set UnitOfWorkManager before use it.");
                }
        ...
        public IGeevMvcConfiguration GeevMvcConfiguration { get; set; }
        ...
        protected override JsonResult Json(object data, string contentType, Encoding contentEncoding, JsonRequestBehavior behavior)
        {
            ...
            return GeevJson(data, contentType, contentEncoding, behavior);
        }

        protected virtual GeevJsonResult GeevJson(
            object data,
        ...
        private void SetCurrentMethodInfoAndWrapResultAttribute(ActionExecutingContext filterContext)
        {
            ...
            _wrapResultAttribute =
                ReflectionHelper.GetSingleAttributeOfMemberOrDeclaringTypeOrDefault(
                    _currentMethodInfo,
                    GeevMvcConfiguration.DefaultWrapResultAttribute
                );
        }
