...
{
    public abstract class GeevSessionBase : IGeevSession
    {
        public const string SessionOverrideContextKey = "Geev.Runtime.Session.Override";
        ...
        protected GeevSessionBase(IMultiTenancyConfig multiTenancy, IAmbientScopeProvider<SessionOverride> sessionOverrideScopeProvider)
        {
