...
using Geev.Events.Bus.Factories;
using Geev.Events.Bus.Factories.Internals;
using Geev.Events.Bus.Handlers;
using Geev.Events.Bus.Handlers.Internals;
using Geev.Extensions;
using Geev.Threading;
using Geev.Threading.Extensions;
using Castle.Core.Logging;

namespace Geev.Events.Bus
{
    /// <summary>
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new GeevException(message));
                    }
                }
            }
