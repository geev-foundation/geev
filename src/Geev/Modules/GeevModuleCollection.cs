...
{
    /// <summary>
    /// Used to store GeevModuleInfo objects as a dictionary.
    /// </summary>
    internal class GeevModuleCollection : List<GeevModuleInfo>
    {
        public Type StartupModuleType { get; }

        public GeevModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : GeevModule
        {
            var module = this.FirstOrDefault(m => m.Type == typeof(TModule));
            if (module == null)
            {
                throw new GeevException("Can not find module for " + typeof(TModule).FullName);
            }
        ...
        public List<GeevModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<GeevModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(GeevKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<GeevModuleInfo> modules, Type startupModuleType)
        {
