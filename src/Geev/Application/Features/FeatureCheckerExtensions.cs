...
namespace Geev.Application.Features
{
    ...
    public static class FeatureCheckerExtensions
    {
        ...
        /// 
        /// This is a shortcut for <see cref="GetValue(IFeatureChecker, int, string)"/> that uses <see cref="IGeevSession.TenantId"/>.
        ...
        /// 
        /// This is a shortcut for <see cref="IsEnabled(IFeatureChecker, int, string)"/> that uses <see cref="IGeevSession.TenantId"/>.
        /// Note: This method should be used only if the TenantId can be obtained from the session.
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker"/> instance</param>
        ...
        /// <summary>
        /// Checks if a given feature is enabled. Throws <see cref="GeevAuthorizationException"/> if not.
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker"/> instance</param>
        /// <param name="featureName">Unique feature name</param>
        public static async Task CheckEnabledAsync(this IFeatureChecker featureChecker, string featureName)
        {
            if (!(await featureChecker.IsEnabledAsync(featureName)))
            {
                throw new GeevAuthorizationException(string.Format(
                    L(
                        featureChecker,
                        "FeatureIsNotEnabled",
        ...
        /// <summary>
        /// Checks if one or all of the given features are enabled. Throws <see cref="GeevAuthorizationException"/> if not.
        /// </summary>
        /// <param name="featureChecker"><see cref="IFeatureChecker"/> instance</param>
        /// <param name="requiresAll">True, to require that all the given features are enabled. False, to require one or more.</param>
        /// <param name="featureNames">Names of the features</param>
        ...
        public static string L(IFeatureChecker featureChecker, string name, string defaultValue)
        {
            ...
            {
                return localizationManager.Object.GetString(GeevConsts.LocalizationSourceName, name);
            }
        }
    }
}