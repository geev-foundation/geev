...
namespace Geev.Application.Features
{
    ...
    public interface IFeatureChecker
    {
        ...
        /// This is a shortcut for <see cref="GetValueAsync(int, string)"/> that uses <see cref="IGeevSession.TenantId"/> as tenantId.
        ...
        /// 
        /// This is a shortcut for <see cref="IsEnabledAsync(int, string)"/> that uses <see cref="IGeevSession.TenantId"/>.
