...
namespace Geev.Threading.Timers
{
    /// <summary>
    ...
    public class GeevTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public GeevTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new GeevException("Period should be set before starting the timer!");
            }
