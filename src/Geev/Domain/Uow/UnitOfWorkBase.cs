...
namespace Geev.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// </summary>
        public IGeevSession GeevSession { protected get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(GeevSession.TenantId, false);
        ...
        public virtual IDisposable SetTenantId(int? tenantId, bool switchMustHaveTenantEnableDisable)
        {
            ...
            if (switchMustHaveTenantEnableDisable)
            {
                mustHaveTenantEnableChange = tenantId == null
                    ? DisableFilter(GeevDataFilters.MustHaveTenant)
                    : EnableFilter(GeevDataFilters.MustHaveTenant);
            }
            else
            {
            ...
            var mayHaveTenantChange = SetFilterParameter(GeevDataFilters.MayHaveTenant, GeevDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(GeevDataFilters.MustHaveTenant, GeevDataFilters.Parameters.TenantId, tenantId ?? 0);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new GeevException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new GeevException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, GeevDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new GeevException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
