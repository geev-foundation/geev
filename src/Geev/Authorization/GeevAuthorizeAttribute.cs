...
namespace Geev.Authorization
{
    ...
    public class GeevAuthorizeAttribute : Attribute, IGeevAuthorizeAttribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="GeevAuthorizeAttribute"/> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public GeevAuthorizeAttribute(params string[] permissions)
        {
