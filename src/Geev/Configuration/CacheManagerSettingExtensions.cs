...
namespace Geev.Configuration
{
    ...
    public static class CacheManagerSettingExtensions
    {
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(GeevCacheNames.ApplicationSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<int, Dictionary<string, SettingInfo>>(GeevCacheNames.TenantSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(GeevCacheNames.UserSettings);
        }
    }
}
