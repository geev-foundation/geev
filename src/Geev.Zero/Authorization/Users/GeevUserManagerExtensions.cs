...
namespace Geev.Authorization.Users
{
    ...
    public static class GeevUserManagerExtensions
    {
        ...
        //public static GeevUserManager<TRole, TUser> Login<TRole, TUser>(GeevUserManager<TRole, TUser> manager, string userNameOrEmailAddress, string plainPassword, string tenancyName = null)
        //    where TRole : GeevRole<TUser>, new()
        //    where TUser : GeevUser<TUser>
        //{
        //    if (manager == null)
