...
(function ($) {
    ...
    geev.ajax = function (userOptions) {
        ...
        var options = $.extend({}, geev.ajax.defaultOpts, userOptions);
    ...
    $.extend(geev.ajax, {
        ...
        ajaxSendHandler: function (event, request, settings) {
            if (!settings.headers || settings.headers[geev.security.antiForgery.tokenHeaderName] === undefined) {
                request.setRequestHeader(geev.security.antiForgery.tokenHeaderName, geev.security.antiForgery.getToken());
            }
        }
    });
