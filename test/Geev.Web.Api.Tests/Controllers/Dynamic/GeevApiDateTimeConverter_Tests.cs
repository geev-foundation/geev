...
namespace Geev.Web.Api.Tests.Controllers.Dynamic
{
    public class GeevApiDateTimeConverter_Tests
    {
        [Theory]
        ...
        public void DateTimeConverter_Utc_Tests(string sourceDate)
        {
            ...
            var dto = JsonConvert.DeserializeObject<DateTimeConverterTestDto>("{date: \"" + sourceDate + "\"}", new GeevDateTimeConverter());
