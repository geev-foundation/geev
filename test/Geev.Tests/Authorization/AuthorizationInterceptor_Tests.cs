...
namespace Geev.Tests.Authorization
{
    public class AuthorizationInterceptor_Tests : TestBaseWithLocalIocManager
    {
        ...
        public AuthorizationInterceptor_Tests()
        {
            ...
            LocalIocManager.IocContainer.Register(Component.For<IGeevSession>().Instance(session));
        ...
        public void Test_Authorization_Sync()
        {
            ...
            Assert.Throws<GeevAuthorizationException>(() => _syncObj.MethodWithPermission3());
            _syncObj.Called_MethodWithPermission3.ShouldBe(false);

            Assert.Throws<GeevAuthorizationException>(() => _syncObj.MethodWithPermission1AndPermission3WithRequireAll());
        ...
        public async Task Test_Authorization_Async()
        {
            ...
            await Assert.ThrowsAsync<GeevAuthorizationException>(async () => await _asyncObj.MethodWithPermission3Async());
            _asyncObj.Called_MethodWithPermission3.ShouldBe(false);

            await Assert.ThrowsAsync<GeevAuthorizationException>(async () => await _asyncObj.MethodWithPermission1AndPermission3WithRequireAllAsync());
        ...
        public void Test_Authorization_For_Protected_Sync()
        {
            ...
            Assert.Throws<GeevAuthorizationException>(() => _syncObjForProtectedMethod.MethodWithPermissionForProtected());
        ...
        public async Task Test_Authorization_For_Protected_Async()
        {
            ...
            await Assert.ThrowsAsync<GeevAuthorizationException>(async () => await _asyncObjForProtectedMethod.MethodWithPermissionForProtectedAsync());
            _asyncObjForProtectedMethod.Called_AuthorizedProtectedMethod.ShouldBe(false);
        }

        private void EmptySession()
        {
            LocalIocManager.Resolve<IGeevSession>().TenantId.Returns((int?) null);
            LocalIocManager.Resolve<IGeevSession>().UserId.Returns((int?) null);
        }
        ...
        public class MyTestClassToBeAuthorized_Sync
        {
            ...
            [GeevAuthorize("Permission1", "Permission2")]
            ...
            [GeevAuthorize("Permission1", "Permission3")]
            ...
            [GeevAuthorize("Permission1", "Permission3", RequireAllPermissions = true)]
