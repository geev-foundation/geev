...
namespace Geev.Tests.Startup
{
    public class GeevBootstraper_Tester : TestBaseWithLocalIocManager
    {
        private readonly GeevBootstrapper _bootstrapper;

        public GeevBootstraper_Tester()
        {
            _bootstrapper = GeevBootstrapper.Create<MyTestModule>(options =>
            {
    ...
    public abstract class MyEventCounterModuleBase : GeevModule
    {
