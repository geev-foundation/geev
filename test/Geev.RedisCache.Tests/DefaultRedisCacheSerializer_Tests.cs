...
using Geev.Tests;
using Geev.Tests.Runtime.Caching;
using Shouldly;
using Xunit;
...
namespace Geev.RedisCache.Tests
{
    public class DefaultRedisCacheSerializer_Tests : TestBaseWithLocalIocManager
    {
        ...
        public void Serialize_Class_Test()
        {
            ...
            result.ShouldBe("{\"Payload\":\"{\\\"Field1\\\":42,\\\"Field2\\\":\\\"Stranger Things\\\"}\",\"Type\":\"Geev.RedisCache.Tests.DefaultRedisCacheSerializer_Tests+MyTestClass, Geev.RedisCache.Tests\"}");
        }
        ...
        {
            var json = "{\"Payload\": \"{\\\"Field1\\\": 42,\\\"Field2\\\":\\\"Stranger Things\\\"}\",\"Type\":\"Geev.RedisCache.Tests.DefaultRedisCacheSerializer_Tests+MyTestClass, Geev.RedisCache.Tests\"}";
