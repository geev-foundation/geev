...
namespace Geev.AutoMapper.Tests
{
    public class AutoMapper_Inheritance_Tests
    {
        ...
        private class MyDerivedEntityDto : Geev.Application.Services.Dto.EntityDto
        {
            [AutoMapKey]
        ...
        private class MyDerivedDualKeyEntityDto : Geev.Application.Services.Dto.EntityDto
        {
            [AutoMapKey]
            public new int Id { get; set; }
        ...
        private class MyAutoMapKeyClass2 : Geev.Domain.Entities.Entity
        {
        ...
        private class MyAutoMapKeyClass4 : Geev.Domain.Entities.Entity
        {
