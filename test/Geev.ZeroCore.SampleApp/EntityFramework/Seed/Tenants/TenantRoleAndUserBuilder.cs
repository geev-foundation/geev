...
namespace Geev.ZeroCore.SampleApp.EntityFramework.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var adminUser = _context.Users.FirstOrDefault(u => u.TenantId == _tenantId && u.UserName == GeevUserBase.AdminUserName);
            if (adminUser == null)
            {
