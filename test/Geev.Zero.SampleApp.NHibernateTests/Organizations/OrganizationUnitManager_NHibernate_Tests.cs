...
using Geev.UI;
using Geev.Zero.SampleApp.NHibernate;
using NHibernate.Linq;
using Shouldly;
using Xunit;

namespace Geev.Zero.SampleApp.Organizations
{
    ...
    //    {
    //        GeevSession.TenantId = GetDefaultTenant().Id;
    ...
    //    {
    //        //Act
    //        await _organizationUnitManager.CreateAsync(new OrganizationUnit(GeevSession.TenantId, "Root 1"));
    ...
    //        //Act
    //        await _organizationUnitManager.CreateAsync(new OrganizationUnit(GeevSession.TenantId, "OU11 New Child", ou11.Id));
    ...
    //                new OrganizationUnit(GeevSession.TenantId, "OU112", ou11.Id)
    //                )
    //            );
    //    }
