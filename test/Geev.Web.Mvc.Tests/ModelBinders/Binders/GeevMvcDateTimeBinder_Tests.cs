...
namespace Geev.Web.Mvc.Tests.ModelBinders.Binders
{
    public class GeevMvcDateTimeBinder_Tests
    {
        [Theory]
        ...
        public void DateTimeBinder_Utc_Tests(string sourceDate)
        {
            ...
            var boundDate = new GeevMvcDateTimeBinder().BindModel(new ControllerContext(), binderContext) as DateTime?;
