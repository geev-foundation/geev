...
using Geev.Zero.SampleApp.Tests.TestDatas;
...
namespace Geev.Zero.SampleApp.Tests
{
    ...
    public abstract class SampleAppTestBase<TModule> : GeevIntegratedTestBase<TModule>
        where TModule : GeevModule
    {
        ...
        {
            return GetTenant(GeevTenantBase.DefaultTenantName);
        }
