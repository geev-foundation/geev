...
{
    public class RealTimeNotifier_Tests : GeevZeroTestBase
    {
        ...
        public async Task Should_Notify_Using_Custom_Notifiers()
        {
            ...
            Predicate<UserNotification[]> predicate = userNotifications =>
            {
                ...
                userNotification.TenantId.ShouldBe(GeevSession.TenantId);
                userNotification.UserId.ShouldBe(GeevSession.UserId.Value);
                ...
                notification.TenantId.ShouldBe(GeevSession.TenantId);
